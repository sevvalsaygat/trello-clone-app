...
const AccountDropdown: React.FC<AccountDropdownPropTypes> = () => {
  ...
  return (
    <div className="flex flex-col">
      <h2 className="text-xs leading-4 text-slate-850 px-5 mt-4 mb-2 font-semibold">
      ...
      <div>
        <div className="flex flex-row px-5 py-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-slate-900 text-xs leading-4">
              sevvallsstt@gmail.com
            </div>
          </div>
        </div>
        <div className="border-b border-gray-350">
          <div className="text-slate-950 text-sm leading-5 px-5 py-2 cursor-pointer hover:bg-zinc-300">
      ...
      <h2 className="text-slate-850 text-xs leading-4 font-semibold px-5 mt-4 mb-2">
