    ...
    <div className="p-3">
      <div className="px-3">
        <div className="flex flex-col max-w-336 hover:bg-zinc-300 cursor-pointer rounded-3">
          ...
          <h3 className="text-16 leading-5 text-slate-950 p-2 font-semibold text-center mb-2">
            {t("labels.description", SCOPE_OPTIONS)}
          </h3>
        </div>
        <div className="flex justify-center mb-5">
          <button className="text-14 leading-5 text-blue-800 hover:underline font-medium w-full">
        ...
        <div className="flex flex-wrap py-2 gap-1 max-w-336 justify-center px-9">
          <div className="text-14 leading-5 text-slate-900 hover:text-slate-950 py-6 px-2 hover:bg-gray-350 rounded-3 cursor-pointer transition-all duration-100">
