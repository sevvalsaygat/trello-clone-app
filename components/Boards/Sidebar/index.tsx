    ...
    <div className="text-black break-all whitespace-pre-line mx-4 w-[256px]">
      <div className="flex flex-col w-full border-b border-gray-350 gap-1">
        <div className="flex flex-row px-2 py-1.5 items-center border-transparent rounded-lg hover:bg-gray-350 cursor-pointer transition-all duration-100 gap-3">
          ...
          <div className="text-sm text-slate-950 leading-5 font-medium">
        ...
        <div className="flex flex-row px-2 py-1.5 items-center border-transparent rounded-lg hover:bg-gray-350 cursor-pointer transition-all duration-100 gap-3 mb-1">
          <div className="p-1">
      ...
      <div className="py-3 w-full">
        <div className="flex flex-row items-center justify-between">
          <div className="text-xs leading-4 text-slate-900 pl-3 py-2 font-medium">
        ...
        <div role="travel" className="flex flex-col">
          <div className="flex flex-col">
            <button
              ...
              className="flex flex-row justify-between hover:bg-gray-350 rounded-lg transition-all duration-100 cursor-pointer mb-1 w-full"
            >
              <div className="flex flex-row px-3 py-1.5 gap-2 items-center">
                <div className="flex justify-center items-center w-6 h-6 border-transparent rounded font-bold text-white text-sm bg-gradient-to-t from-blue-750 from-10% via-indigo-900 via-70% to-violet-900 to-90%">
                  T
                </div>
                <div className="text-sm leading-5 text-slate-950 font-medium">
            ...
            {travelWorkspacesisActive && (
              <div>
                <div className="flex flex-row items-center py-1.5 pl-11 pr-2 gap-3 cursor-pointer bg-blue-200 rounded-lg mb-1">
                  <Icons.SvgBoardTrello className="text-slate-900" />
                  <div className="text-blue-800 text-sm leading-5">
                    {t("travelWorkspaceItems.labels.boards", SCOPE_OPTIONS)}
                  </div>
                </div>
                <div className="flex flex-row items-center py-1.5 pl-11 pr-2 gap-3 cursor-pointer hover:bg-gray-350 rounded-lg transition-all duration-100 mb-1">
                  <Icons.SvgHeart className="text-slate-900 w-4 h-4" />
                  <div className="text-slate-950 text-sm leading-5">
                    {t("travelWorkspaceItems.labels.highlights", SCOPE_OPTIONS)}
                  </div>
                </div>
                <div className="group/item flex flex-row items-center justify-between py-1.5 pl-11 pr-1 cursor-pointer hover:bg-gray-350 rounded-lg transition-all duration-100 mb-1">
            ...
            <div className="premium-card border-y border-gray-350 rounded-3">
              <div className="px-3">
                <div className="flex flex-row justify-between items-center mt-4 mb-2">
                  <div className="text-slate-950 text-sm leading-4 font-medium">
                ...
                <div className="text-sm leading-5 text-slate-900 mb-4">
                  {t("premiumCard.labels.content", SCOPE_OPTIONS)}
                </div>
                <div className="flex flex-row justify-between mb-4">
                  <button className="text-slate-900 hover:text-slate-950 text-sm leading-5 underline">
