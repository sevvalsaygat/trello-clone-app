  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row pb-3">
        ...
        <h1 className="text-base leading-6 text-slate-950 font-bold">
          {t("labels.title", SCOPE_OPTIONS)}
        </h1>
      </div>
      <div className="flex flex-row">
        <div className="flex relative mr-4 mb-4 cursor-pointer w-48 h-24">
          <Image
            src="/board.jpg"
            width={180}
            height={96}
        ...
        <div className="flex mr-4 mb-4 p-2 cursor-pointer w-48 h-24 bg-zinc-300 hover:bg-gray-350 rounded-3">
          <div className="flex justify-center items-center w-full h-full text-sm leading-5 text-slate-950">
