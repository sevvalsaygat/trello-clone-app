            ...
            <div className="flex flex-col">
              <div className="flex flex-row">
                <button className="group/item flex relative mr-3">
                  <div className="flex justify-center items-center w-60 h-60 border-transparent rounded font-bold text-white text-4xl bg-gradient-to-t from-blue-750 from-10% via-indigo-900 via-70% to-violet-900 to-90%">
                    T
                  </div>
                  <span className="hidden group-hover/item:block text-sm leading-8 absolute h-8 bottom-0 bg-neutral-500 text-white font-bold w-full justify-center items-center underline">
